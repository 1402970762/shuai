...
SSH_FILE_PATH = "/home/user/Monitor_script/monitor_perf.py"
...
remote_re_file = "/home/user/Monitor_script/requirements.txt"
remote_dir = "/home/user/Monitor_script/"
maxBytes = 102400
backupCount = 10
remote_file1 = "/home/user/Monitor_script/monitor_perf.py"
remote_file2 = "/home/user/Monitor_script/requirements.txt"
...
def teee():
    ...
    for dics in conf_txt:
        ...
        try:
            ...
            sftp.put(file_local_file, remote_file2)
        except Exception as e:
            print(e)
            print("从本地： %s 上传到： %s" % (local_file, remote_file))
        ssh.close()
